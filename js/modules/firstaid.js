  ...
  continuations: {
    CPR: {
      ...
      shock: "🫀 Если человек в шоке (после СЛР):\n\n" +
        "Шок — состояние, когда организм ослаблен и не справляется. Мозг перезагружается — тело может реагировать странно.\n\n" +
        "Признаки:\n" +
        ...
        "4. Говори спокойно, тихо, повторяй: «Всё хорошо, ты в безопасности, скорая едет».\n" +
        "5. Следи за дыханием — если остановится, начинай СЛР.\n" +
        "6. Позови взрослых или позвони 103.\n\n" +
        "⚠️ В редких случаях человек может быть возбуждён, дёргаться, пытаться схватить. Это не агрессия — это рефлексы. Если так:\n" +
        "• Не подставляй руки и лицо близко\n" +
        "• Говори спокойно, не спорь, не удерживай\n" +
        "• Убери опасные предметы рядом\n" +
        "• Позови взрослых, жди 103\n\n" +
        "📌 Ты не один. Взрослые помогут. Зови их.",
